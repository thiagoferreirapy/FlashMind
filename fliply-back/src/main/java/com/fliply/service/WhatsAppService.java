...
public class WhatsAppService {
    ...
    public void sendChallenge(User user, UserSettings settings) {
        ...
        if (card == null) {
            ...
            sendMessage(normalizePhone(phone), "Nenhum card disponível no momento. Estude no Fliply para gerar novos desafios! 📖");
            return;
        }
    ...
    public void processWebhookAnswer(String phone, String userAnswer) {
        ...
        if (results.isEmpty()) {
            ...
            sendMessage(normalizedPhone, "Nenhum desafio pendente. Abra o Fliply para estudar! 📖");
            return;
        }

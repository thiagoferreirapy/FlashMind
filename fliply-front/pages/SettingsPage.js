...
export class SettingsPage {
  ...
  async render() {
    ...
    catch { this.settings = { dailyGoal: 20, sessionSize: 10, smartOrder: true, whatsappEnabled: false, notificationsEnabled: true } }
    ...
    return `
      <div class="animate-fade">
        ...
        <div style="padding:var(--space-md)">
          ...
          <div class="settings-group mb-md">
            <div class="settings-item">
              <div class="settings-item-icon" style="background:rgba(59,130,246,0.15)">${icon('bell', 18)}</div>
              ...
              <label class="toggle"><input type="checkbox" id="toggle-notif" ${s.notificationsEnabled !== false ? 'checked' : ''}><span class="toggle-slider"></span></label></div>
            <div class="settings-item">
  ...
  _bindEvents() {
    ...
    this.container.querySelector('#toggle-notif')?.addEventListener('change', e => toggleSave('notificationsEnabled', e.target.checked))

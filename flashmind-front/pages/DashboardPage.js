    ...
    return `
      <div class="animate-fade">
        ...
        <div style="padding:var(--space-md)">
          ...
          ${(d.dueCards ?? []).length > 0 ? `
          <div class="section-header"><div class="section-title">Próximas Revisões</div></div>
          ${d.dueCards.map(c => `
          ...
          <div class="section-header ${(d.dueCards ?? []).length > 0 ? 'mt-md' : ''}"><div class="section-title">Cards Críticos</div></div>
          ...
          <div class="section-header mt-md"><div class="section-title">Cards Dominados</div></div>
          ...
          <div class="section-header mt-md"><div class="section-title">Atividade Recente</div></div>
          ${d.recentActivity.slice(0, 5).map((s, i) => `
            <div class="deck-card mb-sm">
              <div class="deck-card-icon" style="background:rgba(124,58,237,0.12)">${i + 1}</div>
